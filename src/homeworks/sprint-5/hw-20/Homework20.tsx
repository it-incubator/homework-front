 ...
 * Появится белый экран (или чёрный, если у вас выбрана тёмная тема 🙂). В консоли - ошибка.
 *
 ...
 * Под капотом в ней используется react class component (и его методы жизненного цикла)
 *
 * 📝 Задание:
 ...
 * - Когда произойдёт ошибка, `ErrorBoundary` должен отобразить текст генерируемой ошибки.
 * Для этого можете использовать `FallbackComponent`: https://github.com/bvaughn/react-error-boundary?tab=readme-ov-file#errorboundary-with-fallbackcomponent-prop
 *
 *
 * 🧙‍♂️ Несколько советов на будущее:
