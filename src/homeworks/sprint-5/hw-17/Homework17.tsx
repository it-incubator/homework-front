 ...
 *
 * 🧙‍♂️ Вы можете найти готовую реализацию, но попробуйте затем написать её самостоятельно (Подобное задание часто даётся на собеседованиях).
 */
...
// 🧙‍♂️ Для типизации используется Generic
export function useDebounce<T>(value: T, delay: number = DEBOUNCE_DELAY): T {
  const [debouncedValue, setDebouncedValue] = useState<T>(value)

  // 📝 Завершите реализацию
  // 🧙‍♂️ вам скорее всего понадобятся `useEffect`, `setTimeout`, `clearTimeout`
