import gryffindorImg from './images/Gryffindor_ClearBG.webp'
import ravenclawImg from './images/RavenclawCrest.webp'
import hufflepuffImg from './images/Hufflepuff_ClearBG.webp'
import slytherinImg from './images/Slytherin_ClearBG.webp'
...
export const houses: HouseFullInfo[] = [
  ...
  },
  {
    ...
    traits: [
      ...
      { id: '78db6224-33d1-490d-a553-9bbbedb3282a', name: 'Intelligence' },
  ...
  },
  {
    ...
    traits: [
      ...
      { id: '36dad9bf-010e-47ef-8908-ecb6d5acfac5', name: 'Self-preservation' },
