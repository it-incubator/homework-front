...
/*
 * Задание
 * 1. Отрендери список пользователей. В этот раз используй компонент UserItem
 * 2. Реализуй фильтрацию пользователей. При нажатии на кнопку "Show me only users from Los Angeles 🌴",
 * должны отобразиться только пользователи из Лос-Анджелеса
 * 3. Добавь типизация там, где это необходимо (удали все any)
 *
 * Дополнительное задание:
 * - добавь кнопку "Reset filter" которая будет сбрасывать фильтр и снова показывать всех пользователей
 * */
